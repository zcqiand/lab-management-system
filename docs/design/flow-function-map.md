...
| M04.F05.I01 ~ M04.F09.I03 | 基础数据活跃码表（技术要求 + 型号/规格/等级/牌号），不直接参与试验流程；M04.F01-F04/F10 已废弃 |
| M06.F01.I01 ~ M06.F07.I07 | 检测能力，属于基础码表与计算/评定规则 + 报告名称，喂养试验流程 |
...
| 步骤 | 名称 | 输入 | 输出 | 支撑功能子项 |
|---|---|---|---|---|
| D01 | 报告类别维护 | 类别信息 | 类别 CRUD（已废弃，由 M06.F07 + 检测能力收口） | M04.F01.I01, M04.F01.I02, M04.F01.I03, M04.F01.I04 |
| D02 | 报告模板维护 | 模板信息 | 模板 CRUD（已废弃，由 M06.F07 报告名称取代） | M04.F02.I01, M04.F02.I02, M04.F02.I03 |
| D03 | 标准管理 | 标准信息 | 标准 CRUD（已废弃，由 M06.F04 检测标准替代） | M04.F03.I01, M04.F03.I02, M04.F03.I03, M04.F03.I04 |
| D04 | 检测参数管理 | 参数信息 | 参数 CRUD（已废弃，由 M06.F03 检测参数替代） | M04.F04.I01, M04.F04.I02, M04.F04.I03 |
| D05 | 技术要求管理 | 技术要求 | 要求 CRUD | M04.F05.I01, M04.F05.I02, M04.F05.I03 |
| D06 | 四码维护 | 型号/规格/等级/牌号 | 码表 CRUD；列表按检测专项过滤 | M04.F06.I01, M04.F06.I02, M04.F06.I03, M04.F07.I01, M04.F07.I02, M04.F07.I03, M04.F08.I01, M04.F08.I02, M04.F08.I03, M04.F09.I01, M04.F09.I02, M04.F09.I03 |
...
| 步骤 | 名称 | 输入 | 输出 | 支撑功能子项 |
| --- | --- | --- | --- | --- |
| C01 | 检测专项维护 | 专项信息 | 专项 CRUD | M06.F01.I01, M06.F01.I02, M06.F01.I03 |
| C02 | 检测项目维护 | 项目信息 | 项目 CRUD | M06.F02.I01, M06.F02.I02, M06.F02.I03 |
| C03 | 项目检测依据关联 | 项目/标准 | 标准角色为 TESTING 的关系 | M06.F02.I04 |
| C04 | 项目判定依据关联 | 项目/标准 | 标准角色为 JUDGMENT 的关系 | M06.F02.I05 |
| C05 | 项目检测参数关联 | 项目/参数 | 项目参数多对多 | M06.F02.I06 |
| C06 | 检测参数维护 | 参数信息 | 参数 CRUD | M06.F03.I01, M06.F03.I02, M06.F03.I03 |
| C07 | 检测标准维护 | 标准元数据 | 标准 CRUD | M06.F04.I01, M06.F04.I02, M06.F04.I03 |
| C08 | 标准检测参数关联 | 标准/参数 | 标准参数多对多 | M06.F04.I04 |
| C09 | 计算规则维护 | 项目/参数/算法/条件 | 计算规则 CRUD | M06.F05.I01, M06.F05.I02, M06.F05.I03 |
| C10 | 技术要求维护 | 项目/参数/判定标准/条件/限值 | 技术要求 CRUD | M06.F06.I01, M06.F06.I02, M06.F06.I03 |
| C11 | 报告名称列表 | 报告名称 | 列表 + 排序 + 关联计数 | M06.F07.I01 |
| C12 | 报告名称新建/编辑 | 报告名称 | 维护 code/name/sortOrder/description | M06.F07.I02 |
| C13 | 报告名称删除 | 报告名称 | 删除保护 | M06.F07.I03 |
| C14 | 报告名称关联检测项目 | 报告名称/项目 | 维护 InspectionObjectReportName | M06.F07.I04 |
| C15 | 报告名称关联检测依据 | 报告名称/标准 | 维护 InspectionReportNameStandard role=TESTING | M06.F07.I05 |
| C16 | 报告名称关联判定依据 | 报告名称/标准 | 维护 InspectionReportNameStandard role=JUDGMENT | M06.F07.I06 |
| C17 | 报告名称关联检测参数 | 报告名称/参数 | 维护 InspectionReportNameParameter | M06.F07.I07 |
