...
import { renderReportHtml, wrapReportDocument, type ReportContext } from '../../../src/features/report-doc/renderReport'
...
describe('renderReportHtml 报告模板渲染', () => {
  it('替换 {{路径.字段}} 标签，含 resultLabel 派生字段', () => {
  ...
  it('{{samplesTable}} 生成样品表且包含类别扩展属性列', () => {
  ...
  it('{{testItemsTable}} 生成检测结果表（参数名/技术要求/评定）', () => {
  ...
  it('wrapReportDocument 组装完整 HTML 文档', () => {
