...
describe("MSW model/specification/grade/brand handlers", () => {
  ...
  fnTest(["M04.F06.I02"], "POST /models 创建成功", async () => {
    const res = await fetch(`${API_BASE}/models`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "热轧带肋钢筋", remark: "HRB400" }),
    });
    expect(res.status).toBe(201);
  });
  ...
  fnTest(["M04.F06.I03"], "DELETE /models/:id 删除成功", async () => {
    const created = await (
      await fetch(`${API_BASE}/models`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "待删除型号" }),
      })
    ).json();
  ...
  fnTest(["M04.F07.I02"], "POST /specifications 创建成功", async () => {
    const res = await fetch(`${API_BASE}/specifications`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "Φ22", remark: "直径22mm" }),
    });
    expect(res.status).toBe(201);
  });
  ...
  fnTest(["M04.F07.I03"], "DELETE /specifications/:id 删除成功", async () => {
    const created = await (
      await fetch(`${API_BASE}/specifications`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "待删除规格" }),
      })
    ).json();
  ...
  fnTest(["M04.F08.I02"], "POST /grades 创建成功", async () => {
    const res = await fetch(`${API_BASE}/grades`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "Ⅰ级", remark: "接头等级" }),
    });
    expect(res.status).toBe(201);
  });
  ...
  fnTest(["M04.F08.I03"], "DELETE /grades/:id 删除成功", async () => {
    const created = await (
      await fetch(`${API_BASE}/grades`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "待删除等级" }),
      })
    ).json();
  ...
  fnTest(["M04.F09.I02"], "POST /brands 创建成功", async () => {
    const res = await fetch(`${API_BASE}/brands`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "HRB400", remark: "热轧带肋400" }),
    });
    expect(res.status).toBe(201);
  });
  ...
  fnTest(["M04.F09.I03"], "DELETE /brands/:id 删除成功", async () => {
    const created = await (
      await fetch(`${API_BASE}/brands`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ inspectionObjectCode: "OBJ-SP01-P2", name: "待删除牌号" }),
      })
    ).json();
