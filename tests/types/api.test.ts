...
describe("types/api 业务实体（v3）", () => {
  fnTest(["M02.F01.I01"], "Contract 类型可构造且字段符合预期", () => {
  ...
  fnTest(["M04.F01.I01"], "ReportCategory 携带扩展属性定义与汇总口径", () => {
  ...
  fnTest(["M04.F01.I04"], "CategoryStandard / CategoryDictItem 均归属报告类别", () => {
  ...
  fnTest(
    ["M03.F03.I01"],
    "Sample 归属接样单 receiptId，含型号/规格/等级/牌号与扩展属性",
    () => {
      const sample: Sample = {
        id: "s-001",
        receiptId: "rc-001",
  ...
  fnTest(["M03.F03.I02"], "TestItem 归属样品 sampleId，自动评定 + 最终评定", () => {
    const item: TestItem = {
      id: "ti-001",
      sampleId: "s-001",
  ...
  fnTest(["M01.F03.I01"], "Role / Permission / User 类型可构造", () => {
  ...
  fnTest(["M01.F05.I01"], "ApiResult 成功与失败两态可构造", () => {
  ...
  fnTest(["M03.F01.I01"], "Page 分页结构与 PageQuery 查询参数", () => {
